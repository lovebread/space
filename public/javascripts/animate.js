// JavaScript Document
	...
	function retroClock(){
		...
		// get new time
		 ...
		 if( h != h_current){
			flip('hoursUp', 'hoursDown', h, '/images/Single/Up/'+ap+'/', '/images/Single/Down/'+ap+'/');
			h_current = h;
		}
		
		if( m2 != m2_current){
			flip('minutesUpRight', 'minutesDownRight', m2, '/images/Double/Up/Right/', '/images/Double/Down/Right/');
			m2_current = m2;
			
			flip('minutesUpLeft', 'minutesDownLeft', m1, '/images/Double/Up/Left/', '/images/Double/Down/Left/');
			m1_current = m1;
		}
		
		 if (s2 != s2_current){
			flip('secondsUpRight', 'secondsDownRight', s2, '/images/Double/Up/Right/', '/images/Double/Down/Right/');
			s2_current = s2;
			
			flip('secondsUpLeft', 'secondsDownLeft', s1, '/images/Double/Up/Left/', '/images/Double/Down/Left/');
			s1_current = s1;
		}
